# -*- coding: utf-8 -*-
#
# reasy documentation build configuration file, created by
# sphinx-quickstart on Mon Jun 15 13:07:09 2015.
#
...
author = u'{{ cookiecutter.copyright_holder }}'
...
man_pages = [
    (master_doc, '{{ cookiecutter.name }}', u'{{ cookiecutter.name }} Documentation',
     [author], 1)
]
